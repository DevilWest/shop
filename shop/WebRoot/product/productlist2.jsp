...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="method!productupdate4?id={sid_user}" target="ajaxTodo" title="确定要通过吗?" ><span>审核通过</span></a></li>
			
			<li><a class="delete" href="method!productupdate5?id={sid_user}" target="ajaxTodo" title="确定要不通过吗?" ><span>审核不通过</span></a></li>
